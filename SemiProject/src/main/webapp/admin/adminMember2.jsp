...
<jsp:include page="adminSideBar.jsp"></jsp:include>
	...
	<form action="/searchNotice.admin?cpage=1" method=post>
		...
		<div class="row" style="background-color:#e1e1e1;border-top:1px solid black;border-bottom:1px solid black;">
			<div><input type=checkbox name="checkAll"></div>
			<div class="col-1">ID</div>
			<!-- <div class="col-1">PW</div> -->
			<div class="col-1">로그인ID</div>
		...
		<c:forEach var="dto" items="${list}">
			<div class=row style="text-align:center;">
				...
				<div class="col-1">${dto.member_id}</div>
				<!-- <div class="col-1">${dto.member_pw}</div> -->
				<div class="col-1">${dto.login_id}</div>
				<div class="col-1">${dto.member_name}</div>
				<div class="col-1">${dto.member_nickname}</div>
				<div class="col-1">${dto.member_zipcode}</div>
				<div class="col-1">${dto.member_address1}</div>
				<div class="col-1">${dto.member_address2}</div>
				<div class="col-1">${dto.member_ssn}</div>
				<div class="col-1">${dto.member_phone}</div>
				<div class="col-1">${dto.member_email}</div>
				<div class="col-1">${dto.admin_yn}</div>
				<div class="col-1">${dto.avgAge}</div>
				<div class="col-1">${dto.kakao_login_yn}</div>
				<div class="col-1">${dto.blacklist}</div>
		   			<a href='/mod.admin?seq=${dto.member_id}'><input type=button value=수정 ></a>
		   		</div>
			</div>
		</c:forEach>
		</c:otherwise>
