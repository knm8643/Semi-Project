...
<jsp:include page="adminSideBar.jsp"></jsp:include>
	...
	<form action="/searchQnA.admin?cpage=1" method=post>
		...
		<c:otherwise>
		<form action="/deleteQnA.admin" method=post id="frm">
			...
			<div class=row style="text-align:center;">
				...
				<div class="col-xs-12 col-sm-1" id=view_count>${dto.view_count }</div>
		   		<div class="col-xs-12 col-sm-2">
		   			<a href='/detail.qna?seq=${dto.seq}'><input type=button value=보기></a>
		   			<a href='/modQnA.admin?seq=${dto.seq}'><input type=button value=수정 ></a>
		   		</div>
			</div>
		</c:forEach>
		</c:otherwise>
