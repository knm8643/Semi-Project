...
<body>
	...
	<form action="/modifyProc.recipe" method="post" id="frmDetail">
		<div class="container" style="padding: 10px;">
			...
			<input type="text" name="title" placeholder="제목을 입력하세요." value="${dto.rc_title }" style="margin: 10px ;width: 100%; border: none; font-size:15px;">
		

			<!--  summernote API -->
			<div class="row">
				<div class="col-3">
					<textarea id="summernote" name="content">${dto.rc_contents }</textarea>
				</div>
			</div>
