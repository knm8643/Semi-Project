...
<body>
	...
	<div class=container>
		<div class=row id=article>
			...
			<div class=col-12 id=btns align=right style="padding:0px;">
				<a href="/list.notice?cpage=1"><input type=button value="목록으로"></a>
				<c:if test="${dto.writer == loginID }"> <!--추후 관리자계정 생성시 수정 요망-->
	...
	<script>
		...
		$("#mod").on("click",function(){ <!--댓글 수정 버튼 클릭-->	
			location.href="/mod.notice?seq=${dto.seq}";
		});
