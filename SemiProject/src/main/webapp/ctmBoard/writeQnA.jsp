...
<style>
	*{
	...
	#titleDiv{height:33px;}
	#contentDiv{height:610px;}
	#btns{height:33px;}
	...
	<form action="/insert.qna" method=post>
		<div class=container>
			<div class=row id=article>
				<div class=col-12 id=titleDiv><input type=text id=title name=title placeholder="글 제목을 입력하세요" size=100%></div>
				<div class=col-12 id=contentDiv>
					<textarea rows=25 cols=131 id="summernote" name="contents" placeholder="글 내용을 입력하세요"></textarea>
				</div>
				<div class=col-12 id=btns align=right>
					<a href="javascript:history.back()"><input type=button value="목록으로"></a>
